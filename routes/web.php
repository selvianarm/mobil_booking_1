...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('booking/{id}/approve', [BookingAdminController::class, 'approve'])->name('booking.approve');
    Route::post('booking/{id}/rejected', [BookingAdminController::class, 'reject'])->name('booking.rejected');
